...
;; color scheme
(define base00 #(37 36 46))
(define base01 #(68 64 69))
(define base02 #(99 92 92))
(define base03 #(130 120 115))
(define base04 #(161 149 138))
(define base05 #(192 177 161))
(define base06 #(223 205 184))
(define base07 #(255 234 207))
(define base08 #(199 80 62))
(define base09 #(250 184 108))
(define base0A #(105 176 199))
(define base0B #(49 120 145))
(define base0C #(62 199 128))
(define base0D #(171 178 66))
(define base0E #(194 33 79))
(define base0F #(255 185 163))

(define framework:color-schemes
  `(#hash((name . "Base16 Melon Dark")
